...
import hu.nagyi.sixthweekwork.databinding.ActivityModifyAdvertisementBinding
import java.io.ByteArrayOutputStream
import java.net.URLEncoder
import java.util.*
import kotlin.collections.ArrayList

class ModifyAdvertisementActivity : AppCompatActivity() {

    //region VARIABLES

    lateinit var binding: ActivityModifyAdvertisementBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.binding = ActivityModifyAdvertisementBinding.inflate(this.layoutInflater)
    ...
    private fun advertisementUpload(imageUrl: String = "") {
        ...
        val docRef: DocumentReference = FirebaseFirestore.getInstance().collection(
        ...
        docRef.set(advertisement)
            .addOnSuccessListener {
                Toast.makeText(
                    this@ModifyAdvertisementActivity,
                    "Advertisement MODIFIED", Toast.LENGTH_LONG
                ).show()
        ...
        newImagesRef.putBytes(imageInBytes)
            .addOnFailureListener { exception ->
                ...
                newImagesRef.downloadUrl.addOnCompleteListener { task ->
                    this@ModifyAdvertisementActivity.advertisementUpload(
